...
public class Konstanter
{
    ...
    public static long BeregnLavGrenseTrygdeavgift()
    {
        return (long)Math.Round((AVG_FRI_TRYGDEAVGIFT * TRYGDE_PROSENT) / (TRYGDE_PROSENT - LAV_TRYGDEAVG_PROSENT));
    }
    public static long BeregnHoyGrenseTrygdeavgift()
    {
        return (long)Math.Round((AVG_FRI_TRYGDEAVGIFT * TRYGDE_PROSENT) / (TRYGDE_PROSENT - HOY_TRYGDEAVG_PROSENT));
    }
}
